...
<?php
/**
 * Plugin Name: Custom WooCommerce Order Export
 * Plugin URI: https://woocommerce.com/products/woocommerce-order-export/
 * Description: add custom fields to order export csv file
 * Version: 1.0.0
 ...
 *
 * Text Domain: custom-woocommerce-order-export
